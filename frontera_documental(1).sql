...
--
-- Servidor: localhost
-- Tiempo de generación: 24-10-2016 a las 15:41:06
...
CREATE TABLE IF NOT EXISTS `datosdiarios` (
...
INSERT INTO `empresas` (`id`, `nit`, `nombre`, `representante`, `descripcion`, `telefono`, `direccion`, `email`) VALUES
(27, 432789, 'TECNHMICRO', 'Mauricio Orozco', 'Empresa de desarollo tecnologico y automatizacion de procesos', '(+57) 3203940388', 'Av 3 n14-25 la cabrera', 'Techmicro@gmail.com'),
(28, 223452, 'ALMAXIMO S.A.S', 'Yein Contreras', 'Empresa de tipo retail', '(+57) 3203940388', 'Av 6 calle x centro', 'almaximo@hotmail.com.co'),
(44, 256221235, 'camilo', 'bautista', 'pruea', '3132456321', 'cnakks 23', 'jajsj@hotmal.com');
...
(9, 'Admin', '12345', 'carlosxx', 'baba', '65122050e1829fcd69a3811d784e682bb8dc3e1adaccd3d5737c38b729db5655e2eed4e26f3aa5b53e3dd69829417d1678cc9d17cc66af7f3ec4203df8061447', 'jajsjs@hotmail.com', 'active', '1', '2013-01-03 08:00:00', 'no-pic.png', 'Coordinacion Operativa', '1,20,21,22,9,10,11,4', '1477311252', '1477309700', 0),
