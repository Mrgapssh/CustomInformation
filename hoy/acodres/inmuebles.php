...
<div class="col-md-9">
     ...
     <div class="row">
      <a href="<?=base_url()?>settings/add_tinmuebles" class="btn btn-primary" data-toggle="mainmodal">Agregar Tipo de Producto</a>
      ...
      <div class="row">
         ...
         <div class="table-head">Tipo de Producto</div>
         <div class="table-div">
		...
		<tr id="<?=$value->id;?>" >
			...
			<td class="option" width="8%">
				        <button type="button" class="btn-option delete po" data-toggle="popover" data-placement="left" data-content="<a class='btn btn-danger po-delete ajax-silent' href='<?=base_url()?>settings/delete_tinmuebles/<?=$value->id;?>'><?=$this->lang->line('application_yes_im_sure');?></a> <button class='btn po-close'><?=$this->lang->line('application_no');?></button> <input type='hidden' name='td-id' class='id' value='<?=$value->id;?>'>" data-original-title="<b><?=$this->lang->line('application_really_delete');?></b>"><i class="fa fa-times"></i></button>
				        <a href="<?=base_url()?>settings/editar_tinmuebles/<?=$value->id;?>" class="btn-option" data-toggle="mainmodal"><i class="fa fa-cog"></i></a>
			</td>
		</tr>
