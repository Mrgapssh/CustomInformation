...
<!-- Preloader -->
      ...
      <div class="row">
        ...
        <div class="col-lg-3 col-xs-12">
          <div class="white-box">
            ...
            <img src="<?=base_url()?>assets/blueline/plugins/images/alert2.png" alt="alert" onload="sa-title" class="img-responsive model_img"
             id="sa-title"> </div>
        </div>
        <div class="col-lg-3 col-xs-12">
          <div class="white-box">
            <h3 class="box-title">Success Message <small>(Click on image)</small></h3>
            <img src="<?=base_url()?>assets/blueline/plugins/images/alert3.png" alt="alert"  class="img-responsive model_img" id="sa-successs"> </div>
      ...
      <div class="row">
        <div class="col-lg-4 col-xs-12">
          <div class="white-box">
            <h3 class="box-title">A basic message <small>(Click on image)</small></h3>
            <img src="<?=base_url()?>assets/blueline/plugins/images/alert5.png" alt="alert" class="img-responsive model_img" id="sa-params"></div>
        </div>
        <div class="col-lg-4 col-xs-12">
          <div class="white-box">
            <h3 class="box-title">Alert with Image <small>(Click on image)</small></h3>
            <img src="<?=base_url()?>assets/blueline/plugins/images/alert7.png" alt="alert" class="img-responsive model_img" id="sa-image"> </div>
        </div>
        <div class="col-lg-4 col-xs-12">
          <div class="white-box">
            <h3 class="box-title">Alert with time <small>(Click on image)</small></h3>
            <img src="<?=base_url()?>assets/blueline/plugins/images/alert6.png" alt="alert" class="img-responsive model_img" id="sa-close"> </div>
        </div>
      </div>
      <!-- /.row -->
      <!-- .right-sidebar -->
