            ...
            <table id="myTable" class="table table-striped">
                                            ...
                                            <thead >
                                                <tr class="headings" >
                                                  ...
                                                  <th><P ALIGN="center">ARRIENDO</</P></th>
                                                  <th><p align="center">SERVICIOS</p></th>
                                                  <th><p align="center">BRIGADA</p></th>
                                                  <th><p align="center">MESEROS</p></th>
                                                  <th><p align="center">GASTO ALIMENTOS</p></th>
                                                  <th><p align="center">GASTO BEBIDAS</p></th>
                                                  <th><p align="center">UTILIDAD</p></th>
                                                  <th><p align="center">TOTAL</p></th>
                                                  <th><p align="center">TOTAL + UTILIDAD</p></th>
                                     ...
                                     <td ALIGN="center"><?=number_format($value->arriendo,  0, '', '.');?></td>
                                     <td ALIGN="center"><?=number_format($value->servicios, 0, '', '.');?></td>
                                     <td ALIGN="center"><?=number_format($value->brigada, 0, '', '.');?></td>
                                     <td ALIGN="center"><?=number_format($value->meseros, 0, '', '.');?></td>
                                     <td ALIGN="center"><?=number_format($value->alimentos, 0, '', '.');?></td>
                                     <td ALIGN="center"><?=number_format($value->bebidas, 0, '', '.');?></td>
                                     <td ALIGN="center"><?=number_format($value->utilidad, 0, '', '.');?></td>
                                      <td ALIGN="center"><?php echo number_format($cpa=$value->arriendo+$value->servicios+$value->brigada+$value->meseros+$value->alimentos+$value->bebidas, 0, '', '.');   ?></td>
                                      
                                     <td ALIGN="center"><?php echo number_format($cps=$cpa+($cpa*0.50), 0, '', '.');   ?></td>
