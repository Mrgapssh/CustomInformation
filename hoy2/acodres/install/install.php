...
switch($_GET['step']){
	...
	<?php 
      ...
      if(extension_loaded('eaccelerator')){$error = TRUE; $check17 = "<span class='label label-danger'>Must be disabled</span>";}else{$check8 = "<span class='label label-success'>OK</span>";}
...
VALUES (1, '2.3.0', '$domain', '$email', '$company', '$tax', '$currency', '1', '1', '', '', 
