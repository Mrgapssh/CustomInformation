        ...
        <div class="col-sm-12">
          <div class="white-box">
            ...
            <table id="myTable" class="table table-striped">
                                            ...
                                            <thead >
                                                <tr class="headings" >
                                                  <th><P ALIGN="center">NIT </</P></th>
                                                  <th><P ALIGN="center">NOMBRE </</P></th>
                                                  <th><p align="center">REPRESENTANTE</p></th>
                                                  <th><p align="center">TELEFONO</p></th>
                                                  <th><p align="center">DIRECCION</p></th>
                                      ...
                                      <td class="hidden-xs"><?=$value->nit;?></td>
                                     <td><?=$value->nombre;?></td>
...
swal({
  title: "Estas Seguro?",
  text: "Estas a punto de eliminar el perfil de una empresa",
  type: "warning",
...
function(isConfirm){
  if (isConfirm) {
    swal("Borrado!", "El perfil de la empresa ha sido borrado", "success");
